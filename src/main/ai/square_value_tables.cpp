...
const std::array<int64_t, 64> *kingEndGameSquareValues = new std::array<int64_t, 64>{
...
const std::array<int64_t, 64> *queenSquareValues = new std::array<int64_t, 64>{
...
const std::array<int64_t, 64> *bishopSquareValues = new std::array<int64_t, 64>{
...
const std::array<int64_t, 64> *knightSquareValues = new std::array<int64_t, 64>{
...
const std::array<int64_t, 64> *rookSquareValues = new std::array<int64_t, 64>{
        0, 0, 0, 0, 0, 0, 0, 0,
...
const std::array<int64_t, 64> *pawnSquareValues = new std::array<int64_t, 64>{
        0, 0, 0, 0, 0, 0, 0, 0,
